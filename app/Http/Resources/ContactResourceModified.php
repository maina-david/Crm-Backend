...
class ContactResourceModified extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        foreach ($contact_details as $key => $contact_detail) {
            ...
            $contact_detail_key_value[$key]["data_type"] = $contact_detail->contact_form_attr->data_type;
            $contact_detail_key_value[$key]["form_id"] = $contact_detail->contact_form_attr->id;
            $contact_detail_key_value[$key]["lable"] = $contact_detail->contact_form_attr->name;
            $contact_detail_key_value[$key]["data_id"] = $contact_detail->id;
            $contact_detail_key_value[$key]["value"] = $option;
        }
